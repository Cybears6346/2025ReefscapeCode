...
public class TeamColorSideAuto extends Command {
  ...
  private final double targetEncoderValue = 31 
  ; // EDIT THIS TO CHANCE THE DISTANCE (0.3 speed, 22; 0.5 speed, 20)
  private boolean isFinished = false;

  public TeamColorSideAuto(Driving driving, Shooter shooter, Elevator elevator, SequentialCommandGroup commandGroup, Timer timer) {
      ...
      this.commandGroup  = new SequentialCommandGroup(
            new TimedTurnTeamColor(driving, timer),
